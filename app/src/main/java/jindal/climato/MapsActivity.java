...
import jindal.climato.Weather.GenericUtils;
import jindal.climato.Weather.WeatherMainActivity;
import com.google.android.gms.common.ConnectionResult;
import com.google.android.gms.common.api.GoogleApiClient;
import com.google.android.gms.location.LocationListener;
import com.google.android.gms.location.LocationRequest;
                ...
                if (!desiredPlace.equals("")) {
                    ...
                    try {
                        ...
                        if (addressList.size() > 0) {
                            ...
                            if(desiredAddress.getLocality()!=null){
                                sb.append(desiredAddress.getLocality()).append("\n");
                            }
                            //village
                            if(desiredAddress.getAdminArea()!=null){
                                sb.append(desiredAddress.getAdminArea()).append("\n"); //state
                            }


                            // sb.append(desiredAddress.getPostalCode()).append("\n");
                            if(desiredAddress.getCountryName()!=null){
                                sb.append(desiredAddress.getCountryName());
                            }
