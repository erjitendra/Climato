...
//                Toast.makeText(getBaseContext(), "Sorry, Product listing failed", Toast.LENGTH_SHORT).show();
    ...
    private void setOutputInUI(String dynamicAddress, ParsedOutput parsedOutput) {
        ...
        humidity.setText(String.valueOf(parsedOutput.getHumidity().intValue()+"%"));
        avgTempreature.setText(String.valueOf(parsedOutput.getTemperatureMean().intValue()+"°C"));
        maxTempreature.setText(String.valueOf(parsedOutput.getTemperatureMax()+"°C"));
        minTempreature.setText(String.valueOf(parsedOutput.getTemperatureMin()+"°C"));
